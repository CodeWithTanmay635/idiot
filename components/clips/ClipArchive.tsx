...
import { ClipBackground } from "./ClipBackground";
import { ClipStage } from "./ClipStage";
import { ClipCaption } from "./ClipCaption";
...
export function ClipArchive({ clips }: ClipArchiveProps) {
  ...
  const bgClip = clips[bgIndex] ?? clips[0];
  ...
  return (
    <>
      ...
      <main
        ...
        aria-label="Surveillance Clips Archive"
      >
        <ClipBackground
        ...
        >
          <div className={styles.headerLeft}>
            ...
            <span className={styles.headerTag}>SURVEILLANCE ARCHIVE</span>
            <span className={styles.headerSep}>//</span>
        ...
        >
          ...
          <h1 className={styles.headingTitle}>THE FOOTAGE</h1>
        </div>

        <section className={styles.stageArea} aria-label="Current Clip Frame">
          <ClipStage
            clip={currentClip}
            index={currentIndex}
            total={clips.length}
