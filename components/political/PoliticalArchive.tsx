...
import { PoliticalBackground } from "./PoliticalBackground";
import { PoliticalStage } from "./PoliticalStage";
import { PoliticalCaption } from "./PoliticalCaption";
...
interface PoliticalArchiveProps {
  exhibits: PoliticalExhibit[];
}

export function PoliticalArchive({ exhibits }: PoliticalArchiveProps) {
  ...
  const currentExhibit = exhibits[currentIndex] ?? exhibits[0];
  const bgExhibit = exhibits[bgIndex] ?? exhibits[0];
  ...
  return (
    <>
      ...
      <main
        ...
        aria-label="Political Affiliation Archive"
      >
        <PoliticalBackground
        ...
        >
          <div className={styles.headerLeft}>
            <span className={styles.headerNum}>04</span>
            <span className={styles.headerSep}>/</span>
            <span className={styles.headerTag}>POLITICAL DOSSIER</span>
            <span className={styles.headerSep}>//</span>
        ...
        >
          ...
          <h1 className={styles.headingTitle}>POLITICAL DOSSIER</h1>
        </div>

        <section className={styles.stageArea} aria-label="Current Exhibit Frame">
          <PoliticalStage
